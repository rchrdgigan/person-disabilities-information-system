    ...
    <div class="card">
        <div class="card-header bg-primary">
          ...
          <button href="" class="btn btn-success float-right"
            ...
            <a href="{{route('disability.arclist')}}" class="btn btn-secondary mr-2 float-right"
            type="button"><i class="fa fa-eye" aria-hidden="true"></i> Archived</a>
        </div>
        ...
        <div class="modal-content">
            ...
            <i class="animation__shake fa fa-6x fa-question-circle text-info" aria-hidden="true"></i>
                <div class="card-body" id="viewInfo">
                    ...
                    <form action="{{route('disability.archive')}}" method="post">
                        @csrf
                        @method('PUT')
